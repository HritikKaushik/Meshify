...
export class RocketRideRagService implements RagPort {
	 ...
	 * context + the user's actual question, see buildRagPrompt in platform-api)
	 * — this pipeline is a bare LLM call, so there is nothing else to extract
	 * from the response besides the answer text.
	 */
